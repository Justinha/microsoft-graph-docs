...
|[x509CertificateAuthenticationMethodConfiguration](x509certificateauthenticationmethodconfiguration.md)|A user can authenticate with X.509 certificates against Azure AD for Windows SmartCard sign-in and for applications and browser sign-in. |Read the configuration details for the X.509 certificate authentication method in the authentication methods policy.|
